...
//
//     final employeeaddParams = employeeaddParamsFromJson(jsonString);
...
// EmployeeaddParams employeeaddParamsFromJson(String str) =>
//     EmployeeaddParams.fromJson(json.decode(str));

// String employeeaddParamsToJson(EmployeeaddParams data) =>
...
//   factory EmployeeaddParams.fromJson(Map<String, dynamic> json) =>
//       EmployeeaddParams(

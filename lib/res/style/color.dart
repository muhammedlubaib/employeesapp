...
class ColorResources {
  static const Color primary = Color.fromARGB(255, 228, 241, 247);
  static const Color backgroundColor = Color.fromARGB(255, 251, 253, 255);
  static const Color textfieldBordercolor = Color.fromARGB(255, 134, 183, 228);
  //Color(0xff141e3c);

  static const Color buttonColor = Color.fromARGB(255, 52, 133, 209);
  static const Color errorStyle = Colors.red;
  static const Color GREY = Color(0xFF939393);

  static const Color textColor = Color(0xff141e3c);
  ...
  static const Color baseColor = Color.fromARGB(169, 217, 218, 228);
  ...
  static const shadowCommon = [BoxShadow(blurRadius: 25, color: shadowColor)];
  ...
  static const Color shadowColor = Color(0xFFEEF3FA);
